...
if __name__ == "__main__":
    ...
    ########################################################## add dpo
    parser.add_argument("--dpo", default=1, type=int) #now only support 1
    ...
    parser.add_argument("--dpo_max_corpus_len", default=600, type=int) #limit maximum dpo dataset token per dpo item. if avoid OoM decrease this value

    parser.add_argument("--gpu_arch", default="rocm", type=str) # if cuda environment set cuda

    # parser.add_argument("--dpo_eval_file", default="validset.save", type=str)

    parser.add_argument("--lora", action="store_true")
    parser.add_argument("--lora_load", default="", type=str) #not implemented not working
